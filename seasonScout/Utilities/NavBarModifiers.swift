...
class NavBarOffsetHostingController<Content: View>: UIHostingController<Content> {
    ...
    private lazy var navBarBlurView: UIVisualEffectView = {
        let blurView = UIVisualEffectView(effect: UIBlurEffect(style: .systemThinMaterial)) // Blur effect for the navbar
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.navigationController?.navigationBar.setBackgroundImage(UIImage(), for: .default) // Make navbar transparent
    ...
    override func viewWillDisappear(_ animated: Bool) {
        ...
        self.navigationController?.navigationBar.titleTextAttributes = [NSAttributedString.Key.foregroundColor: UIColor.label] // Reset title color
        self.navigationController?.navigationBar.setBackgroundImage(nil, for: .default) // Reset background
